...
const Invitation = () => {
  ...
  return (
    <motion.section
      ...
      style={{
        backgroundImage: `url(${isMobile ? invitationBg : invitationBg})`,
      }}
    ...
    >
      ...
      <div className="relative z-10">
        ...
        <p className="max-w-3xl mx-auto text-lg md:text-xl font-body mt-6 leading-relaxed">
          🌴 <span className="text-green-400 font-semibold">Set in the fiery heart of the neighborhood</span>, where
          smoke swirls like battle cries and tongs clash like swords — Muma's backyard transforms into a grill-powered arena
          of flavor!
        </p>
        <motion.button
          ...
          className="mt-12 px-8 py-3 bg-red-600 hover:bg-red-700 text-white font-bold font-heading text-xl rounded-none border-2 border-white shadow-lg"
        >
          Get Tickets
        </motion.button>
      </div>
